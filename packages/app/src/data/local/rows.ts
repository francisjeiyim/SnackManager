...
export const toSettings = (r: Row): Settings => ({
  ...
  soundRepeatSeconds: n(r.soundRepeatSeconds),
...
export const toGuest = (r: Row): Guest => ({
  ...
  validatedHalfSets: n(r.validatedHalfSets),
  extensionMinutes: n(r.extensionMinutes),
  extensionYen: n(r.extensionYen),
  extensionSets: n(r.extensionSets),
  extensionHalfSets: n(r.extensionHalfSets),
